  ...
  switch (status) {
    ...
    case "IN_PROGRESS":
      return {
        ...
        className:
          "border-transparent bg-emerald-500/10 text-emerald-700 dark:text-emerald-400 uppercase text-[11px] font-semibold tracking-wide hover:bg-emerald-500/15",
      };
    case "COMPLETED":
      return {
        ...
        variant: "default" as const,
        className:
          "border-transparent bg-sky-500/10 text-sky-700 dark:text-sky-400 uppercase text-[11px] font-semibold tracking-wide hover:bg-sky-500/15",
      };
    case "CANCELLED":
      return {
        ...
        className:
          "border-transparent bg-red-500/10 text-red-700 dark:text-red-400 uppercase text-[11px] font-semibold tracking-wide hover:bg-red-500/15",
      };
    default:
      return {
        label: status,
